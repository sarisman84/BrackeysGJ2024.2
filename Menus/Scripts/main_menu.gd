...
@onready var m_quit_button = $background/quit_button
...
func _ready() -> void:
	...
	m_start_button.mouse_entered.connect(m_button_hover_sfx.play)
	m_options_button.mouse_entered.connect(func(): m_button_hover_sfx.play())
	m_quit_button.mouse_entered.connect(func(): m_button_hover_sfx.play())
